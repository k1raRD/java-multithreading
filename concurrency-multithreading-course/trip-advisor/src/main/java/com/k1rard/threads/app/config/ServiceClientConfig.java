package com.k1rard.threads.app.config;
...
public class ServiceClientConfig {
    ...
    @Bean
    public AcommodationServiceClient accommodationServiceClient(@Value("${accommodation.service.url}") String baseUrl){
        return new AcommodationServiceClient(buildRestClient(baseUrl));
    }
